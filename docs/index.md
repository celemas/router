...
Celema Router is a PSR-7/PSR-15 router and view dispatcher. Define routes on `Router`, run requests through `RoutingHandler`, and use named routes for strict URL generation.
...
```bash
composer require celema/router
```

Celema Router targets PHP 8.5 and works with PSR-7 requests/responses, PSR-11 containers, PSR-15 middleware, and PSR-15 request handlers. You provide your preferred PSR-7/PSR-17 implementation.
...
$router->url('albums.show', ['id' => 13], host: 'https://celema.dev');
// https://celema.dev/cms/albums/13
```
...
$router->asset('assets', 'app.css', host: 'https://cdn.celema.dev');
// https://cdn.celema.dev/assets/app.css
```
